...
const std::string DFLT_SERVER_ADDRESS	{ "tcp://post-cn-n6w1qkoir06.mqtt.aliyuncs.com:1883" };
const std::string DFLT_CLIENT_ID		{ "GID_eosio@@@02" };
const std::string TOPIC { "eosio_topic" };
const int	QOS = 1;

const std::string USERNAME("Signature|LTAI4GH1apSz8vxHgPBs6uh8|post-cn-n6w1qkoir06");
const std::string PASSWORD("GYqWG/QD6OSpfJMjf7BTyDYR+Tc=");
...
int main(int argc, char* argv[])
{
	...
	mqtt::connect_options conopts(USERNAME, PASSWORD);
