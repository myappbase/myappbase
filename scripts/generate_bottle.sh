...
mkdir -p ${PROJECT}/${VERSION}/opt/myappbase/lib/cmake
...
echo "class Eosio < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/myappbase/myappbase/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/myappbase/myappbase/releases/download/v${VERSION}\"
